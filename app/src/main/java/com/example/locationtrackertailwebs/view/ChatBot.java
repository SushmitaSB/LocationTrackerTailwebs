...
public class ChatBot extends AppCompatActivity {
    ...
    public String GetText(String query) throws UnsupportedEncodingException {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Bearer "+ "ee7f38faea5d77f6621f5392045da6ff9e3053bc");
...
//            jsonParam.put("name", "order a medium pizza");
            ...
            Log.d("sush", "after conversion is " + jsonParam.toString());
            wr.write(jsonParam.toString());
            wr.flush();
            Log.d("sush", "json is " + jsonParam);
...
//                }
//            }
            Log.d("sush ", "response is " + text);
            return speech;

        } catch (Exception ex) {
            Log.d("sush", "exception at last " + ex);
        } finally {
            try {
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... voids) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.d("sush", "Exception occurred " + e);
            }
